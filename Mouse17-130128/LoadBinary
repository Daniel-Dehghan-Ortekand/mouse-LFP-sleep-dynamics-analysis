%% Binary neural data loading
% This function loads selected channels from a binary neural recording file
% using different loading methods optimized for data size and access pattern.
% It supports loading complete recordings or specific time periods, optional
% downsampling, and conversion between input and output data types. The
% function can also return the original sample indices corresponding to the
% loaded data.
