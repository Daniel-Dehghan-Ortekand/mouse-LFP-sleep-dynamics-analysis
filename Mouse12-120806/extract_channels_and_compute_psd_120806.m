...
% SUBJECT: Mouse12-120806 (Channels 2 and 12)
% =========================================================================
% DESCRIPTION:
% Extracts two specific channels (Channel 2 and Channel 12) from a 
...
% power of 2. The resulting spectra are visualized and saved as a PNG image.
%
% INPUTS:
%   - SWS_episode_new_90.mat: Continuous multi-channel SWS LFP data.
%
% OUTPUTS:
%   - Visualizations: Plot of the Power Spectral Density for the two 
%     selected channels.
...
[Pxx, f] = pwelch(data1', window, noverlap, nfft, fs);
