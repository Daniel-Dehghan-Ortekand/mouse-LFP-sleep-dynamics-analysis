...
% =========================================================================
% FUNCTION: circ_plot - Circular Data Visualization
% SOURCE: Circular Statistics Toolbox for Matlab (Berens & Velasco, 2009)
% =========================================================================
% DESCRIPTION:
% Plots circular data (angles in radians) using various styles. Supports 
% a unit-circle scatter plot ('pretty'), a circular histogram ('hist'), 
% or a basic polar plot. Can optionally overlay the mean resultant vector 
% to show the mean direction and concentration of the data.
%
% INPUTS:
%   - alpha   : Vector of angles in radians.
%   - format  : (Optional) Plot style: 'pretty', 'hist', or '' (default).
%   - formats : (Optional) MATLAB line/marker style string (e.g., 'ro').
%   - varargin: (Optional) Style-specific flags (e.g., show mean vector, 
%               number of bins, normalization) followed by name-value 
%               pairs for line properties (e.g., 'LineWidth', 2).
%
% OUTPUTS:
%   - a       : Handle to the plotted axes.
%
% DEPENDENCIES:
%   - circ_r, circ_mean (from the Circular Statistics Toolbox).
% =========================================================================
