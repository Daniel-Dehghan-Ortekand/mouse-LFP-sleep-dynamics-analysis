...
% with a custom dark theme.
%
% INPUTS:
%   - sepratedSpindles120807.mat: Classified Global and Local spindle 
%     events and their corresponding peak amplitudes.
%   - real_peaks_120807[X].mat: Peak amplitude data for the reference channel.
...
%%
load sepratedSpindles120807 sepratedSpindles120807
...
globamp = sepratedSpindles120807.globalPeaks(1,:);
locamp = sepratedSpindles120807.LocalPeaks(1,:);
...
onsetGlob = transpose(sepratedSpindles120807.globalSPindles(:,1));
offsetGlob = transpose(sepratedSpindles120807.globalSPindles(:,3));
durationGlob = offsetGlob - onsetGlob ;

% duration for locals 

onsetLoc = transpose(sepratedSpindles120807.localSPindles(:,1));
offsetLoc = transpose(sepratedSpindles120807.localSPindles(:,3));
